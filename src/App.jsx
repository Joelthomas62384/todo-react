            ...
            <div className="container mt-14 md:w-2/4 bg-violet-400 h-[30rem] md:min-h-[35rem] mx-auto text-white p-5 rounded-lg shadow-2xl">
                ...
                <div className="flex items-center mt-4">
                    <input
                        id="checked-checkbox"
                        type="checkbox"
                        className="w-4 h-4 text-blue-600 bg-indigo-100 border-indigo-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-indigo-800 focus:ring-2 dark:bg-indigo-700 dark:border-indigo-600"
